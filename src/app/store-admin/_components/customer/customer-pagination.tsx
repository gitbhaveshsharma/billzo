...
import type { CustomerPagination as CustomerPaginationType } from "@/types/customers.types";
...
interface CustomerPaginationProps {
    pagination: CustomerPaginationType;
    totalCustomers: number;
    totalPages: number;
    onPaginationChange: (pagination: Partial<CustomerPaginationType>) => void;
}
...
export function CustomerPagination({
    ...
    const start = totalCustomers === 0 ? 0 : (page - 1) * limit + 1;
