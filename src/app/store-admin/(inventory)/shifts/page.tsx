...
export default function ShiftsPage() {
    ...
    }, [storeId, fetchDashboardStats, fetchActiveShift, fetchTodaySummary]);
    ...
    return (
        <div className="space-y-6 p-4 sm:p-6 lg:p-8">
            {/* Page Header */}
            <div>
                <h1 className="text-2xl font-bold tracking-tight">Cash Shifts</h1>
                <p className="text-sm text-muted-foreground">
                    Manage cash register shifts, movements, and reconciliation.
                </p>
            </div>
